...
class PickupScanAdapter : RecyclerView.Adapter<PickupScanAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        return MyViewHolder(
            LayoutInflater.from(parent.context).inflate(R.layout.item_pickup_scan_list, parent, false)
        ).apply {
            itemClick = { i ->
                this@PickupScanAdapter.itemClick?.invoke(i)
            }
        }
    }
    ...
    class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private lateinit var status: BoldTextView
